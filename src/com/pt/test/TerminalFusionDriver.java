 ...
 *
 */
public class TerminalFusionDriver {
    ...
    public boolean analysisJob() throws Exception {
        ...
        job.setMapperClass(TerminalFusionMapper.class);
        job.setJarByClass(TerminalFusionDriver.class);
        job.setReducerClass(TerminalFusionReducer.class);
        ...
        Path outputDir = new Path(IncDetailOutDir+ "/terminalFusion");
    ...
    public static void main(String[] args) {
        TerminalFusionDriver driver = new TerminalFusionDriver();
